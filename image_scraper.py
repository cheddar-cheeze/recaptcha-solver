...
parser.add_argument('label', type=str, nargs=1, help='The name of the images to download')
parser.add_argument('amt', type=int, nargs=1, help='The maximum amount of images to download')
...
for file in os.listdir(dir):
    ...
    if (file_type == 'image/jpeg') or (file_type == 'image/png'):
        with open(os.path.join(dir, file), 'rb') as f:
            ...
            f.close()
            os.rename(os.path.join(dir, file), os.path.join(dir, shasum + '.{}'.format(file.split('.')[1])))
    else:
